...
local b64encode = loadstring(game:HttpGet("https://raw.githubusercontent.com/Reselim/Base64/master/Base64.lua", true), "Base64")().encode
local players = game:GetService("Players")
local localPlayer = players.LocalPlayer
local scriptPlaceholder = {} -- add getscriptbytecode support here also edite line 424
...
local getData = function()
	local classes = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/MaximumADHD/Roblox-Client-Tracker/roblox/Mini-API-Dump.json", true)).Classes
	local classData = {}
...
local identifiers = setmetatable({}, {
	__index = function(self, obj)
		local rbxi = 'RBX'..game:GetService("HttpService"):GenerateGUID(false):gsub("-", "")
		self[obj] = rbxi
...
savehierarchy = function(h)
	...
	for i0, v0 in h do
		...
		repeat
			...
			--- there is no script decompiler on fluxus lol
...
local savegame = function()
	...
	savefolder('playerGui', localPlayer.PlayerGui:GetChildren())
	savefolder('instances', _nil)
